...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_media_group_block_media_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_id" integer,
  ...
  CREATE TABLE "pages_blocks_media_group_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_media_group_block_media_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"media_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_media_group_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "portfolio_items" ADD CONSTRAINT "portfolio_items_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "portfolio_items_rels" ADD CONSTRAINT "portfolio_items_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_media_group_block_media_items_order_idx" ON "pages_blocks_media_group_block_media_items" USING btree ("_order");
  CREATE INDEX "pages_blocks_media_group_block_media_items_parent_id_idx" ON "pages_blocks_media_group_block_media_items" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_media_group_block_media_items_media_idx" ON "pages_blocks_media_group_block_media_items" USING btree ("media_id");
  CREATE INDEX "pages_blocks_media_group_block_order_idx" ON "pages_blocks_media_group_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_media_group_block_parent_id_idx" ON "pages_blocks_media_group_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_media_group_block_path_idx" ON "pages_blocks_media_group_block" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_media_group_block_media_items_order_idx" ON "_pages_v_blocks_media_group_block_media_items" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_media_group_block_media_items_parent_id_idx" ON "_pages_v_blocks_media_group_block_media_items" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_media_group_block_media_items_media_idx" ON "_pages_v_blocks_media_group_block_media_items" USING btree ("media_id");
  CREATE INDEX "_pages_v_blocks_media_group_block_order_idx" ON "_pages_v_blocks_media_group_block" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_media_group_block_parent_id_idx" ON "_pages_v_blocks_media_group_block" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_media_group_block_path_idx" ON "_pages_v_blocks_media_group_block" USING btree ("_path");
  ...
  CREATE INDEX "portfolio_items_media_idx" ON "portfolio_items" USING btree ("media_id");
  CREATE INDEX "portfolio_items_slug_idx" ON "portfolio_items" USING btree ("slug");
  ...
  CREATE INDEX "portfolio_items_rels_categories_id_idx" ON "portfolio_items_rels" USING btree ("categories_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_homepage_cta_type";`)
}
