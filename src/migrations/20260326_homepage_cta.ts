...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.execute(sql`ALTER TABLE "homepage" DROP COLUMN IF EXISTS "cta_type"`)
  await db.execute(sql`ALTER TABLE "homepage" DROP COLUMN IF EXISTS "cta_new_tab"`)
  await db.execute(sql`ALTER TABLE "homepage" DROP COLUMN IF EXISTS "cta_url"`)
  await db.execute(sql`ALTER TABLE "homepage" DROP COLUMN IF EXISTS "cta_label"`)
